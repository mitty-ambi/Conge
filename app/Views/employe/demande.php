    ...
    <div class="app-wrap">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav" style="margin-top:1rem">
                ...
                <li><a href="#page-form-conge" class="active"><i class="bi bi-plus-circle"></i> Nouvelle demande</a>
                </li>
                    ...
                    <div>
                        <div class="form-section">
                            ...
                            <div class="f-computed">
                                ...
                                <div class="f-computed-label">jours calendaires calculés<br>
                                    <span style="font-size:.7rem;opacity:.7">du lundi 23 au vendredi 27 juin 2025</span>
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <button class="btn-forest" type="submit"><i class="bi bi-send"></i> Soumettre la
                                    demande</button>
                                <a href="#page-dashboard-employe" class="btn-secondary"><i class="bi bi-x"></i>
                                    Annuler</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:1rem">
                        ...
                        <div
                            ...
                            <div style="font-size:.78rem;font-weight:500;color:var(--ink);margin-bottom:.5rem">
                                <i class="bi bi-clipboard-check" style="color:var(--forest);margin-right:5px"></i>Rappel
                                des règles
                            </div>
